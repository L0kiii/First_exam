var nation = ["汉族", "蒙古族", "彝族", "侗族", "哈萨克族", "畲族", "纳西族", "仫佬族", "仡佬族", "怒族", "保安族", "鄂伦春族", "回族", "壮族", "瑶族", "傣族", "高山族", "景颇族", "羌族", "锡伯族", "乌孜别克族", "裕固族", "赫哲族", "藏族", "布依族", "白族", "黎族", "拉祜族", "柯尔克孜族", "布朗族", "阿昌族", "俄罗斯族", "京族", "门巴族", "维吾尔族", "朝鲜族", "土家族", "傈僳族", "水族", "土族", "撒拉族", "普米族", "鄂温克族", "塔塔尔族", "珞巴族", "苗族", "满族", "哈尼族", "佤族", "东乡族", "达斡尔族", "毛南族", "塔吉克族", "德昂族", "独龙族", "基诺族"];
var politicsStatus = ["少先队员", "团员", "群众"];
var householdRegistrationCategory = ["城市", "县镇非农", "农村"];
var professional = {
    "声乐": ["声乐"],
    "理论作曲": ["理论作曲"],
    "舞蹈表演": ["中国舞蹈表演"],
    "中国乐器演奏": ['竹笛', '笙', '唢呐', '扬琴', '柳琴', '中阮', '琵琶', '古筝', '古琴', '二胡', '板胡', '三弦', '民打'],
    "管乐乐器演奏": ['长笛', '双簧管', '单簧管', '萨克斯', '大管', '圆号', '小号', '长号', '大号', '西打'],
    "弦乐乐器演奏": ['小提琴', '中提琴', '大提琴', '低音提琴', '竖琴'],
    "键盘乐器演奏": ['钢琴', "钢琴调律", '手风琴', '双排键'],
    "现代乐器演奏": ['古典吉他', '现代萨克斯', '电吉他', '电贝司', '现打', '现代键盘']
};
...
var provinces = {
    ...
    "四川": {
        "成都市": ["市辖区", "锦江区", "青羊区", "金牛区", "武侯区", "成华区", "龙泉驿区", "青白江区", "新都区", "温江县", "金堂县", "双流县", "郫　县", "大邑县", "蒲江县", "新津县", "都江堰市", "彭州市", "邛崃市", "崇州市"],
        ...
        "绵阳市": ["市辖区", "涪城区", "游仙区", "三台县", "盐亭县", "安　县", "梓潼县", "北川羌族自治县", "平武县", "江油市"],
        ...
        "宜宾市": ["市辖区", "翠屏区", "宜宾县", "南溪县", "江安县", "长宁县", "高　县", "珙　县", "筠连县", "兴文县", "屏山县"],
    ...
    "云南": {
        ...
        "临沧市": ["市辖区", "临翔区", "凤庆县", "云　县", "永德县", "镇康县", "双江拉祜族佤族布朗族傣族自治县", "耿马傣族佤族自治县", "沧源佤族自治县"],
    ...
    "陕西": {
        "西安市": ["市辖区", "新城区", "碑林区", "莲湖区", "灞桥区", "未央区", "雁塔区", "阎良区", "临潼区", "长安区", "蓝田县", "周至县", "户　县", "高陵县"],
        "铜川市": ["市辖区", "王益区", "印台区", "耀州区", "宜君县"],
        "宝鸡市": ["市辖区", "渭滨区", "金台区", "陈仓区", "凤翔县", "岐山县", "扶风县", "眉　县", "陇　县", "千阳县", "麟游县", "凤　县", "太白县"],
        "咸阳市": ["市辖区", "秦都区", "杨凌区", "渭城区", "三原县", "泾阳县", "乾　县", "礼泉县", "永寿县", "彬　县", "长武县", "旬邑县", "淳化县", "武功县", "兴平市"],
        "渭南市": ["市辖区", "临渭区", "华　县", "潼关县", "大荔县", "合阳县", "澄城县", "蒲城县", "白水县", "富平县", "韩城市", "华阴市"],
        "延安市": ["市辖区", "宝塔区", "延长县", "延川县", "子长县", "安塞县", "志丹县", "吴旗县", "甘泉县", "富　县", "洛川县", "宜川县", "黄龙县", "黄陵县"],
        "汉中市": ["市辖区", "汉台区", "南郑县", "城固县", "洋　县", "西乡县", "勉　县", "宁强县", "略阳县", "镇巴县", "留坝县", "佛坪县"],
        "榆林市": ["市辖区", "榆阳区", "神木县", "府谷县", "横山县", "靖边县", "定边县", "绥德县", "米脂县", "佳　县", "吴堡县", "清涧县", "子洲县"],
    ...
    "甘肃": {
        ...
        "庆阳市": ["市辖区", "西峰区", "庆城县", "环　县", "华池县", "合水县", "正宁县", "宁　县", "镇原县"],
        "定西市": ["市辖区", "安定区", "通渭县", "陇西县", "渭源县", "临洮县", "漳　县", "岷　县"],
        "陇南市": ["市辖区", "武都区", "成　县", "文　县", "宕昌县", "康　县", "西和县", "礼　县", "徽　县", "两当县"],
    ...
    "宁夏": {
        ...
        "固原市": ["市辖区", "原州区", "西吉县", "隆德县", "泾源县", "彭阳县", "海原县"],
        "中卫市": ["市辖区", "沙坡头区", "中宁县"]
    },
    "新疆": {
    ...
    "河北": {
        ...
        "邯郸市": ["市辖区", "邯山区", "丛台区", "复兴区", "峰峰矿区", "邯郸县", "临漳县", "成安县", "大名县", "涉　县", "磁　县", "肥乡县", "永年县", "邱　县", "鸡泽县", "广平县", "馆陶县", "魏　县", "曲周县", "武安市"],
        "邢台市": ["市辖区", "桥东区", "桥西区", "邢台县", "临城县", "内丘县", "柏乡县", "隆尧县", "任　县", "南和县", "宁晋县", "巨鹿县", "新河县", "广宗县", "平乡县", "威　县", "清河县", "临西县", "南宫市", "沙河市"],
        "保定市": ["市辖区", "新市区", "北市区", "南市区", "满城县", "清苑县", "涞水县", "阜平县", "徐水县", "定兴县", "唐　县", "高阳县", "容城县", "涞源县", "望都县", "安新县", "易　县", "曲阳县", "蠡　县", "顺平县", "博野县", "雄　县", "涿州市", "定州市", "安国市", "高碑店市"],
        ...
        "沧州市": ["市辖区", "新华区", "运河区", "沧　县", "青　县", "东光县", "海兴县", "盐山县", "肃宁县", "南皮县", "吴桥县", "献　县", "孟村回族自治县", "泊头市", "任丘市", "黄骅市", "河间市"],
...
function addOptions(selectionId, options) {
    let optionElement = $("#" + selectionId);
    $.each(options, (key, value) => {
        optionElement.append($(new Option(value, value)));
    });
}

function initProfessional(categoryId, nameId) {
    let categorySelector = $("#" + categoryId);
    $.each(professional, (category, names) => {
        categorySelector.append($(new Option(category, category)));
    });
    categorySelector.on("change", () => {
        let nameSelector = $("#" + nameId);
        nameSelector.empty();
        let categoryName = $("#" + categoryId).val();
        $.each(professional[categoryName], (index, name) => {
            nameSelector.append($(new Option(name, name)));
        })
    });
}

function initProvinceDetail(provinceId, cityId, areaId) {
    let provinceSelector = $("#" + provinceId);
    let citySelector = $("#" + cityId);
    let areaSelector = $("#" + areaId);
    $.each(provinces, (province, city) => {
        provinceSelector.append($(new Option(province, province)));
    });
    provinceSelector.on("change", () => {
        let provinceSelector = $("#" + provinceId);
        let areaSelector = $("#" + areaId);
        let citySelector = $("#" + cityId);
        citySelector.empty();
        ...
        $.each(provinces[provinceSelector.val()], (city, area) => {
            citySelector.append($(new Option(city, city)));
        });
        if (citySelector.children() != null && citySelector.children().length === 0) {
            citySelector.attr("disabled", true);
        }
        $.each(provinces[provinceSelector.val()][citySelector.val()], (index, area) => {
            areaSelector.append($(new Option(area, area)));
        });
        if (areaSelector.children() != null && areaSelector.children().length === 0) {
    ...
    citySelector.on("mouseover", () => {
        let provinceSelector = $("#" + provinceId);
        let citySelector = $("#" + cityId);
        if (provinceSelector.val() != null && provinceSelector.val().length > 0) {
            if (citySelector.children().not("[disabled]").length <= 1) {
                $.each(provinces[provinceSelector.val()], (city, area) => {
                    if (city !== citySelector.val()) {
                        citySelector.append($(new Option(city, city)));
                    }
                });
            }
    ...
    areaSelector.on("mouseover", () => {
        let provinceSelector = $("#" + provinceId);
        let areaSelector = $("#" + areaId);
        let citySelector = $("#" + cityId);
        if (provinceSelector.val() != null && provinceSelector.val().length > 0) {
            if (areaSelector.children() != null && areaSelector.children().not("[disabled]").length <= 1) {
                $.each(provinces[provinceSelector.val()][citySelector.val()], (index, area) => {
                    if (area !== areaSelector.val()) {
                        areaSelector.append($(new Option(area, area)));
                    }
                });
            }
